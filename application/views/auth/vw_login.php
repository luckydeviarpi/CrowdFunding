...
<head>
    ...
    <title> Login | CrowdFunding - Cai Shen Ye </title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST" action="<?= base_url('Auth/cek_login'); ?>">
                            <div class="form">
                                ...
                                <p class="signup-link">Not registered ? <a href="<?= base_url(); ?>Auth/register">Create an account</a></p>
                            </div>
                        </form>
                    </div>
                </div>
